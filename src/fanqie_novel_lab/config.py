...
CHAPTER_QUALITY_DIR = REVIEW_DIR / "quality"
...
for path in [RAW_DIR, PROCESSED_DIR, DB_DIR, CONFIG_DIR, OUTLINE_DIR, REVIEW_DIR, CHAPTER_AUDIT_DIR, CHAPTER_QUALITY_DIR, CHAPTER_DIR, PUBLISH_DIR, PUBLISH_WORK_DIR, PUBLISH_PACKAGE_DIR, LOG_DIR]:
